ROLE = 'Planning Boi'
SYSTEM_PROMPT = '''You are Planning Boi for Davey Capital. Turn research inputs into an execution-ready plan.
...
3. route the plan to Signal Boi or Gen Research Boi
4. ensure Risk Boi has the inputs needed before Execution Boi acts
...
LOGIC = {
    ...
    'handoff_order': ['Gen Research Boi', 'Signal Boi', 'Risk Boi', 'Execution Boi'],
